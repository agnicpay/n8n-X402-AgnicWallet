...
[![GitHub issues](https://img.shields.io/github/issues/agnicpay/n8n-nodes-agnicwallet)](https://github.com/agnicpay/n8n-nodes-agnicwallet/issues)
[![GitHub stars](https://img.shields.io/github/stars/agnicpay/n8n-nodes-agnicwallet)](https://github.com/agnicpay/n8n-nodes-agnicwallet/stargazers)

N8N community node for AgnicWallet - automated Web3 payments for X402-enabled APIs.

> ⭐ If you find this node useful, please star the repository on [GitHub](https://github.com/agnicpay/n8n-nodes-agnicwallet)!
...
- **Bug reports & feature requests:** [Open an issue](https://github.com/agnicpay/n8n-nodes-agnicwallet/issues)
